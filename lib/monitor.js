...
class Monitor extends Section {
  getAll() {
    return this.axios.get(`/${this.s.$user.auth_token}/monitor/${this.s.$user.ke}`).then(r => r.data);
  }
  ...
  setModeTime(monitorID, mode, time, timeUnit) {
    ...
    return this.axios.get(`/${this.s.$user.auth_token}/monitor/${this.s.$user.ke}/${monitorID}/${time}/${timeUnit}`).then(r => r.data);
  }
  ...
  addOrEdit(monitorID, params) {
    ...
    return this.axios.get(`/${this.s.$user.auth_token}/monitor/${this.s.$user.ke}/${monitorID}`, { params }).then(r => r.data);
  }

  del(monitorID) {
    return this.axios.get(`/${this.s.$user.auth_token}/monitor/${this.s.$user.ke}/${monitorID}/delete`).then(r => r.data);
  }
}
